"""Structural regression tests: /proceed skill file existence and metadata."""
...
class TestSkillFileExists:
    ...
    def test_proceed_skill_exists(self) -> None:
...
class TestFrontmatter:
    ...
    def test_description_non_empty(self, frontmatter: dict) -> None:
