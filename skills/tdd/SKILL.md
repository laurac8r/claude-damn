...
name: tdd
description:
   Invoke test-driven development as an explicit one-at-a-time micro-cycle — one
   test, one piece of functionality, refactor, then repeat for the next behavior
user-invocable: true
---
...
RED signal (you never watch _this_ behavior's test fail in isolation), the
...
| Excuse                                                                                                                                          | Reality                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| "Requirements are small / clear / independent — all-tests-first then one-pass impl is _equivalent_ to cycling, just faster"                     | Equivalent output ≠ equivalent process. Batching forfeits the per-behavior RED and the minimal-code discipline. "Just faster" is the justification every batching agent reaches for — run the loop.                                                                                                                                                                                                                                                           |
...
| "Per-behavior red→green only matters when requirements interact or the design is unclear"                                                       | You don't know which behavior will surprise you until it does — that's _why_ you cycle. Reserving the discipline for "hard" cases means never running it, because everything looks easy up front.                                                                                                                                                                                                                                                             |
...
- Reaching for the fully-general solution before the specific tests forced it —
  ...
  test first; implement only what _this_ test demands and let the next test
