...
truncates after 5 items and shows `... +15 pending` for the remainder. The
operator cannot see tasks #6 through #20 from the default render.
...
"laziness" (echoing the truncated form back) is the rationalization to
counter.